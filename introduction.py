...
def Intro():                            #Defines all indented code as Intro
    ...
    time.sleep(2)
    type("Your head is filled with ringing as you faintly hearing some shouting\n")
    time.sleep(2)
    type("You are pulled up and sat down on a chair\n")
    time.sleep(2)
    ...
    time.sleep(2)
    type("'I demand to know what I am doing here!' you call out. Still nothing...\n")
    time.sleep(2)
    type("'All will be revealed soon.' said a woman's voice suddenly\n")
    time.sleep(2)
    ...
    time.sleep(2)
    type("'It will only cost your strength and willpower to relive memories until we find the right one. We need to look through your memories until the right one is triggered.' she walks over to you. 'We want to help you "+name+".'\n")
    time.sleep(2)
    ...
    time.sleep(2)
    type("'Prepare for us to enter your mind. Let the memories flow. Live them as you once did. Change them and this won't work.' the woman turned around and began to walk away. 'Begin memory tap process!' she called.\n")
    time.sleep(2)
