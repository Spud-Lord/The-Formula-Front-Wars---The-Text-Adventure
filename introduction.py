...
def Intro():                            #Defines all indented code as Intro
    ...
    time.sleep(2)
    type("'We work for Admiral James Osbourne. He wants to know how you became like this. Then we will help reverse the effect and cleanse your memory of everything we make you relive.' she says.")
    time.sleep(2)
